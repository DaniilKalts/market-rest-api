...
type User struct {
	...
	PasswordHash string    `json:"password_hash" gorm:"type:varchar(255);not null" binding:"required,min=8" example:"$2a$10$EKq8Yv9Y1WnrDFEdiMYCSOaz/oq2I9l9ngJyH/eBRM3lIbcJRLS02"`
...
type RequestCreateUser struct {
	...
	LastName     string `json:"last_name" gorm:"type:varchar(30);not null" binding:"required,min=2,max=30" example:"Doe"`
	Email        string `json:"email" gorm:"type:varchar(100);uniqueIndex;not null" binding:"required,email" example:"john.doe@example.com"`
	PasswordHash string `json:"password_hash" gorm:"type:varchar(255);not null" binding:"required,min=8" example:"secret12345"`
	PhoneNumber  string `json:"phone_number" gorm:"type:varchar(20)" example:"+12345678901"`
}
...
type RequestUpdateUser struct {
	...
	PasswordHash string `json:"password_hash" binding:"omitempty,min=8" example:"newSecret123"`
